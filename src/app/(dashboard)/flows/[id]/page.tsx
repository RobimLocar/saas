...
// ETAPA 7.6.2 — resoluções REAIS por modelo de imagem (verdade = schema PiAPI).
// Só o Nano Banana Pro suporta 1K/2K/4K de verdade. Flux (~1024–1344px), GPT Image 2
// (1024/1536), Nano Banana flash (fixo) e Qwen (≤1024) → apenas "1K". Sem 2K/4K falso.
function imgResolutions(m: ModelOpt | undefined): string[] {
  return m?.modelId === "nano-banana-pro" ? ["1K", "2K", "4K"] : ["1K"];
}
...
const VCAPS: Record<string, VCaps> = {
  ...
  "seedance-1.5-pro": { endFrame: true, audio: false, multiShot: false, omni: true, aspects: SEEDANCE_ASPECTS, resolutions: ["480p", "720p"], duration: { type: "range", min: 4, max: 15 }, refAudio: true, refVideo: true },
  ...
  "wan-2.1-video": { endFrame: false, audio: true, multiShot: false, omni: false, aspects: ["16:9", "9:16", "1:1", "4:3", "3:4"], resolutions: ["720p", "1080p"], duration: { type: "enum", values: [5, 10, 15] }, wanExtras: true },
};
