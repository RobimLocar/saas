...
export function LanguageSwitcher() {
  ...
  function choose(locale: Locale) {
    // eslint-disable-next-line react-hooks/immutability -- plain document.cookie write inside a click handler (not render/effect); standard way to persist the locale choice.
